...
public:
  ...
  //! восемью гонщиками — 8 x 4096 x 120 Б ≈ 3,9 МБ НА КОМНАТУ, и достигается он только
  //! умышленным выкручиванием: у честного заезда живых записей сотни, не тысячи.
  //! Прежние 256 давали ≈ 245 КБ на комнату — рост реален и принят сознательно: цена
  //! отказа честному касту выше цены четырёх мегабайт на комнату в предельном случае.
