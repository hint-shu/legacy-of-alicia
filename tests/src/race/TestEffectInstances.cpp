...
//! и бюджет выдачи с R71-30 РАВНЫ (4096), поэтому без снятия записей отказ пришёл бы
//! по месту под улику и был бы неотличим от отказа по бюджету, а речь здесь именно
//! о бюджете ([[a-blind-checker-says-clean]]).
